...
use crate::{state::{Listener, StateCell}, dom::DomHtmlElement};
...
extern "C" {
    ...
    pub(super) fn assigned_slot (this: &DomText) -> DomHtmlElement;
}
...
impl StaticText {
    ...
    #[inline]
    pub fn fmt<T: ?Sized + ToString> (t: &T) -> Self {
        Self::constant(&ToString::to_string(t))
    }
}
